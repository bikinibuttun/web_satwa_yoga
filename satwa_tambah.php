                                ...
                                <div class="row g-3">
								 <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="id_satwa" id="subject" placeholder="ID" readonly>
									...
									<div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="nama" id="subject" placeholder="NAMA SATWA" required>
                                            <label for="subject">NAMA SATWA</label>
                                        </div>
                                    </div>
									<div class="col-12">
                                        <div class="form-floating">
                                             <textarea class="form-control" placeholder="biografi." name="biografi" id="subject" style="height: 150px" required></textarea>
                                            <label for="subject">BIOGRAFI</label>
                                        </div>
                                    </div>
									<div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="jumlah" id="subject" placeholder="JUMLAH" required>
